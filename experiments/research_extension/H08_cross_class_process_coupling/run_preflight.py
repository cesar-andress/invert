#!/usr/bin/env python3
"""Preflight for H08_cross_class_process_coupling."""
...
HYPOTHESIS_ID = "H08_cross_class_process_coupling"
...
def main() -> int:
    ...
    checks.append({"check": "generation_required", "ok": True, "note": "frozen-data only"})
