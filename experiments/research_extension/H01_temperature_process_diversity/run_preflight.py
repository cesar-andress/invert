#!/usr/bin/env python3
"""Preflight for H01_temperature_process_diversity."""
...
HYPOTHESIS_ID = "H01_temperature_process_diversity"
...
def main() -> int:
    ...
    notes = [
        ...
        "Estimated generation calls: 1440",
    ]
    write_preflight_result(
        HYPOTHESIS_ID,
        ...
        checks=checks,
        notes=notes,
        estimated_generation_calls=1440,
    )
