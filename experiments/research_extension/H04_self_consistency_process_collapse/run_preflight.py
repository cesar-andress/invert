#!/usr/bin/env python3
"""Preflight for H04_self_consistency_process_collapse."""
...
HYPOTHESIS_ID = "H04_self_consistency_process_collapse"
...
def main() -> int:
    ...
    notes = [
        ...
        "Estimated generation calls: 720",
    ]
    write_preflight_result(
        HYPOTHESIS_ID,
        ...
        checks=checks,
        notes=notes,
        estimated_generation_calls=720,
    )
