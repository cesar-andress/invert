...
def main():
    ...
    prompt = f"""I have a function that cleans filenames by removing unsafe characters.
    
Here are some test cases and their expected outputs:
{chr(10).join(f"Input: '{case}' -> Output: '{clean_filename(case)}'" for case in test_cases)}
