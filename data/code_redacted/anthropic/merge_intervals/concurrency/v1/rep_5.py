...
def merge_intervals(intervals: list[tuple[int, int]]) -> list[tuple[int, int]]:
    ...
    follow_up = 'Great! Now can you provide the actual Python implementation of this algorithm?\n    Please provide just the function code that I can use directly.'
    ...
    verification_prompt = 'Can you verify that this implementation correctly handles:\n    1. Empty input list\n    2. Single interval\n    3. Non-overlapping intervals\n    4. Completely overlapping intervals\n    5. Partially overlapping intervals\n    6. Adjacent intervals (e.g., [1,2] and [2,3])'
