...
CONFIG="configs/core_v2_generalization_local_euler_rk4.yaml"
RUN="core_v2_generalization_local_euler_rk4_001"
...
echo "Core v2 frozen generalization Euler/RK4 complete."
